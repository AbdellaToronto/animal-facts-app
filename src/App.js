    ...
    render() {
            return ( <
                    ...
                    Toggle handleInputChange = {
                        e => this.setAnimalType(e.target.checked ? 'dog' : 'cat')
                    }
                    isDog = {
            ...
            header className = "App-header" >
                <
                Card buttonText = {
                    `Generate a ${this.state.animalType} fact`
                }
            facts = {
                this.state.facts
            }
            handleClick = {
                () => this.getAnimalFact(this.state.animalType, this.state.numberOfFacts)
            }
            /> {
